 ...
 * Address
 *
 * @ORM\Table(name="local_address")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\LocalAddressRepository")
 */
class LocalAddress extends Timestampable
{
	/**
	 * @var int
	 *
	...
	/**
	 * @ORM\OneToOne(targetEntity="Client", mappedBy="localAddress", cascade={"persist"})
	 */
	private $client;
