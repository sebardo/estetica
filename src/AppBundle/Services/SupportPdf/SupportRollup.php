...
class SupportRollup extends SupportPdf
{
	...
	const ROLLUP_OBVERSE_HEADER_X = 'right';
	const ROLLUP_OBVERSE_HEADER_Y = 250;
	const ROLLUP_OBVERSE_HEADER_SPACE_X = 500;
	const ROLLUP_OBVERSE_HEADER_SPACE_Y = 500;
	const ROLLUP_OBVERSE_HEADER_STYLE = self::FONT_STYLE_NORMAL;
	const ROLLUP_OBVERSE_CONTENT_1 = 'rollup-obverse-content-1';
	const ROLLUP_OBVERSE_CONTENT_1_X = 'right';
	const ROLLUP_OBVERSE_CONTENT_1_Y = 300;
	const ROLLUP_OBVERSE_CONTENT_1_SPACE_X = 500;
	const ROLLUP_OBVERSE_CONTENT_1_SPACE_Y = 50;
	const ROLLUP_OBVERSE_CONTENT_1_STYLE = self::FONT_STYLE_NORMAL;
	const ROLLUP_OBVERSE_CONTENT_2 = 'rollup-obverse-content-2';
	const ROLLUP_OBVERSE_CONTENT_2_X = 'right';
	const ROLLUP_OBVERSE_CONTENT_2_Y = 100;
	const ROLLUP_OBVERSE_CONTENT_2_SPACE_X = 0;
	const ROLLUP_OBVERSE_CONTENT_2_SPACE_Y = 50;
	const ROLLUP_OBVERSE_CONTENT_2_STYLE = self::FONT_STYLE_NORMAL;
	const ROLLUP_OBVERSE_CONTENT_3 = 'rollup-obverse-content-3';
	const ROLLUP_OBVERSE_CONTENT_3_X = 'right';
	const ROLLUP_OBVERSE_CONTENT_3_Y = 100;
	const ROLLUP_OBVERSE_CONTENT_3_SPACE_X = 0;
	const ROLLUP_OBVERSE_CONTENT_3_SPACE_Y = 50;
	const ROLLUP_OBVERSE_CONTENT_3_STYLE = self::FONT_STYLE_NORMAL;
	...
	const ROLLUP_OBVERSE_FOOTER_SPACE_Y = 50;
	const ROLLUP_OBVERSE_FOOTER_STYLE = self::FONT_STYLE_SMALL;
	const PAGES = 1;
