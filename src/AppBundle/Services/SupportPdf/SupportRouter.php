...
class SupportRouter extends SupportPdf
{
	...
	const ROUTER_OBVERSE_CONTENT_1_SPACE_Y = 270;
	...
	const ROUTER_OBVERSE_PRIZE_1_SPACE_Y = 450;
	...
	const ROUTER_OBVERSE_PRIZE_2_SPACE_Y = 550;
	...
	const ROUTER_OBVERSE_FOOTER_SPACE_Y = 480;
