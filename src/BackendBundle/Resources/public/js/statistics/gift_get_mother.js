jQuery.fn.extend({
    gift_get_mother: function () {
        ...
        var labels=["Enero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
        /*var areaChartData = {
            labels: ,
            datasets: [
                {
        ...
        var buildChart=function(data)
        {
            ...
            //- LINE CHART -
            //--------------
            var lineChartCanvas = $("#gift-get-mother-canvas").get(0).getContext("2d");
